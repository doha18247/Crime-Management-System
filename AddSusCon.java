...
public class AddSusCon {
    ...
    @FXML
    Button back, AddBtn, miniBtn, clsBtn;
    @FXML
    private TextField Address, Age, Name, Phone, SSN;
    @FXML
    ...
    public void Add(ActionEvent e) throws IOException {
        boolean result = officer.AddSuspect(aCase.CaseID, SSN.getText(), Name.getText(), Age.getText(), handleSubmit(), Phone.getText(), Address.getText(), Description.getText());
        System.out.println(aCase.Suspects.toString());
        if (result) Back(e);
    }
}
