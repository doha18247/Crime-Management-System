...
public class RemoveCrimCon {
    public RemoveCrimCon() {
    }
    ...
    private void showAlert() {
        ...
        alert.setContentText("Criminal doesn't exist.");
    ...
    public void Remove(ActionEvent e) throws IOException {
        boolean result = officer.RemoveCriminal(aCase.CaseID, Name.getText());
        if (result) Back(e);
        else {
            showAlert();
        }
