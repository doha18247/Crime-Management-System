...
public class AddCrimCon {
    ...
    @FXML
    private TextField Address, Age, CurrentLocation, Name, Phone, SSN;
    @FXML
    ...
    public void Add(ActionEvent e) throws IOException {
        boolean result = officer.AddCriminal(aCase.CaseID, SSN.getText(), Name.getText(), Age.getText(), handleSubmit(), Phone.getText(), Address.getText(), CurrentLocation.getText());
