...
public class CreateOfficerCon {
    public CreateOfficerCon() {
    }
    ...
    public void Create(ActionEvent e) throws IOException {
        ...
        if (validpassowrd) {
            boolean result = Admin.getAdmin().CreateOfficer(SSN.getText(), Name.getText(), Age.getText(), handleSubmit(), Phone.getText(), Address.getText(), salary.getText(), username.getText(), password.getText());
            if (result) Back(e);
        }
    }
}